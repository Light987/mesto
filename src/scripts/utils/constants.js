...
const profileAvatar = document.querySelector('.popup-avatar')
const profileImage = document.querySelector('.profile__image')
const avatarAddButton = document.querySelector('.profile__edit-avatar')
...
const popupProfileAvatar = popupProfileForm.querySelector('.popup-avatar__link');
...
const configApi = {
    ...
    headers: {
        authorization: '9c06261a-9d14-4224-9adb-848cb1d56a4b',
